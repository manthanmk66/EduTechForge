...
const LearningGrid = () => {
  return (
    <div className="grid mx-auto w-[350px] pl-4 pt-4  text-white xl:w-fit grid-cols-1 xl:grid-cols-4 mb-12">
          ...
          >
            {card.order < 0 ? (
              ...
              <div className="p-8 flex flex-col gap-8">
                ...
                <p className="text-slate-400 font-medium">{card.description}</p>
              </div>
            )}
          </div>
        );
