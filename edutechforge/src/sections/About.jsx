...
import FoundingStory from "../assets/Aboutpage/Foundingstory.jpg";
...
const About = () => {
  return (
    <div>
      {/* section 1 */}
      <section classname="">
        <div className=" bg-slate-800 relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white">
      ...
      <section className="border-b border-richblack-700">
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-">
